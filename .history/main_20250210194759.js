 ...
 */
function findStationsForSingleAddress() {
  // Retrieve the place from the single address autocomplete.
  const place = autoCompleteSingle.getPlace();
  ...
  map.setCenter(place.geometry.location);
  map.setZoom(15);
  // Optionally, reapply filters (or remove this call if testing marker visibility).
  applyFilters();
}
